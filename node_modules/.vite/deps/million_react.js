...
// node_modules/.pnpm/million@3.0.6_rollup@4.37.0/node_modules/million/dist/shared/million.fb41761f.mjs
var Object$ = Object;
var Map$ = Map;
var Set$ = Set;
...
var renderToTemplate = (vnode, edits = [], path = []) => {
    ...
    if (value) {
      ...
      if (name === "style" && typeof value === "object") {
        ...
        for (const key in value) {
          ...
          let kebabKey = "";
          for (let i = 0, j2 = key.length; i < j2; ++i) {
  ...
  for (let i = 0, j2 = ((_a = vnode.props.children) == null ? void 0 : _a.length) || 0, k = 0; i < j2; ++i) {
...
var ArrayBlock = class extends AbstractBlock {
  ...
  m(parent, refNode = null) {
    if (this._t)
      return this._t;
    for (let i = 0, j2 = this.b.length; i < j2; ++i) {
...
var block = (fn2, unwrap2, shouldUpdate, svg) => {
  const vnode = fn2(HOLE_PROXY);
  const edits = [];
...
var Block = class extends AbstractBlock {
  ...
  m(parent, refNode = null, hydrateNode) {
    ...
    if (elements)
      this.c = elements;
    for (let i = 0, j2 = this.e.length; i < j2; ++i) {
...
// node_modules/.pnpm/million@3.0.6_rollup@4.37.0/node_modules/million/dist/packages/experimental.mjs
var experimental_options = {
  noSlot: false
};

// node_modules/.pnpm/million@3.0.6_rollup@4.37.0/node_modules/million/dist/shared/million.9efd57f2.mjs
...
var scopedContext = E(false);
var processProps = (props, ref, portals) => {
  const processedProps = { ref };
  let currentIndex = 0;
  for (const key in props) {
    const value = props[key];
    if (fn(value) || Array.isArray(value) && value.length && fn(value[0])) {
...
var renderReactScope = (vnode, unstable, portals, currentIndex, key) => {
  ...
  const isBlock = fn(vnode) && typeof vnode.type === "function" && "_c" in vnode.type;
...
var flatten = (rawChildren) => {
  if (rawChildren === void 0 || rawChildren === null)
    return [];
  if (typeof rawChildren === "object" && "type" in rawChildren && rawChildren.type === g) {
...
var useLayoutEffect = typeof window === "undefined" ? _ : A;
...
function useNearestParent(type) {
  ...
  const parentRef = F({ el: null, depth: 0 });
  useLayoutEffect(() => {
    var _a;
...
function useContainer() {
  const fiber = useFiber();
  const rootRef = F({ el: null, depth: 0 });
  useLayoutEffect(() => {
    var _a;
...
// node_modules/.pnpm/million@3.0.6_rollup@4.37.0/node_modules/million/dist/packages/react.mjs
var block2 = (fn2, options = {}) => {
...
To avoid this error, \`experimental_options.noSlot\` should be false`)
    ...
    const marker = q(() => {
      ...
      return y((options == null ? void 0 : options.as) ?? defaultType, { ref });
    }, []);
  ...
  if (options == null ? void 0 : options.name) {
    if (fn2) {
      fn2.displayName = `Million(Render(${options.name}))`;
    }
...
var MillionArray = ({
  ...
  const fragmentRef = F(null);
  const cache = F({
    each: null,
    children: null,
    mounted: false
  });
  const [, setMountPortals] = p(false);
  ...
  const MillionFor = y(
    g,
    null,
    y(as ?? defaultType, { ...rest, ref }),
    ...portals.current.map((p2) => p2.portal)
  );
  _(() => {
...
function compiledBlock(render, { portals, ...options }) {
  ...
  const Component = portals && portalCount > 0 ? (props) => {
    ...
    return y(
      g,
      null,
      y(RenderBlock, derived),
      targets
    );
  } : (props) => y(RenderBlock, props);
  if (options.name) {
